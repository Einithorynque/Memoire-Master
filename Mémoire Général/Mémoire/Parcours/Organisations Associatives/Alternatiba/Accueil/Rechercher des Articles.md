...
Dans le haut de page, le second bouton à gauche est une icône loupe, invitant à rechercher des pages, des contenus. Au clic, c'est un lien qui ouvre « Trouve ce dont tu as besoin ». 

Une fois sur la page, celle ci est divisée en trois sections :
- le formulaire de recherche
- une section « Découvre le Mouvement Alternatiba », avec trois carte présentant les pages déjà dans le haut de page : Climat : pourquoi agir ? Passer à l'action et Le mouvement
- le formulaire pour [[Parcours/Organisations Associatives/Alternatiba/Accueil/S'inscrire à l'Infolettre]]

Le champs de recherche présent sur la page « Trouve ce dont tu as besoin » est aussi présent sur le menu du plan du site, dans le bas de page et sur la page « Articles ». 
